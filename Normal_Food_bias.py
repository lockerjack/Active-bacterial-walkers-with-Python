...
def Initialize_Walkers(N,L):    #Walker Initialization to a square array (Code based on Lennard Jones code from Homeworks)
  ...
  for x in range(0, Nsquare):
    for y in range(0, Nsquare):
        if(added < N):
          ...
          position.append(Reproduction_threshold/3.0)
          added += 1
